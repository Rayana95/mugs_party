        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <span class="nav-link" href="/">Mugs Party <span class="sr-only">(current)</span>
                </li>
                <li class="nav-item active">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-sm-6 footer-box">
                    ...
                    <h4>Mugs Party</h4>On y trouve de tout et surtout du n'importe quoi !!</p>
                ...
                <div class="col-md-12 footer-box">
                    <div class="copyright">
                        <p>&copy; 2021 Mugs Party.Tous droits réservés.</p>
                    </div>
                </div>
            </div>
        </div>
